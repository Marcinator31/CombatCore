...
public final class CombatCore extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.combatManager.setBarriers(barrierManager);
        ...
        getServer().getPluginManager().registerEvents(new RegionListener(this, combatManager, regionManager, configManager, barrierManager), this);
        ...
        this.actionBarTask = new ActionBarTask(this, combatManager, configManager, barrierManager);
